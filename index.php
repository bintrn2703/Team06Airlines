...
<div class="banner">
	<img src="assets/images/banner.svg" alt="banner" class="banner-img" />
	<div class="desc-group">
		<p class="desc-1">BRINGING YOU EXCEPTIONAL PRIVATE TRAVEL</p>
		<p class="desc-2">World-Class <br />Private Charters</p>
		<p class="desc-3">
			Top-Quality worldwide executive jet charter service that gets you
			there faster, in style.
		</p>
	</div>
...
<div class="discover">
	<h2 class="title">Discover what sets us apart</h2>
	<p class="desc">
		A premiere flight service that is unparalleled in both pricing,
		comfort and the time you save.
	</p>
</div>
<div class="main-content">
	<img src="./assets/images/feedback.svg" alt="feedback" class="feedback" />
	<img src="./assets/images/subscription.svg" alt="" class="subscription" />
</div>
<footer class="footer">
	<div class="row">
