        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-transparent ">
            <a class="navbar-brand" href="index.php">
                <h5 class="text-light brand mt-2">
                    <img src="assets/images/lufthansa-cargo-flight-airline-logo-airline-d08e1f34db01cf4e0ee20316aa8a2a45.png" height="70px" width="70px" alt="">
                    Team06 Airlines
                </h5>
            </a>
